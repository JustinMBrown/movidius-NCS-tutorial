...
1. Introduction	2
1.1 The General Idea	2
2. Pre-Reqs	3
2.1 Installing Tensorflow with GPU support	3
2.1.1 Installing CUDA and cuDNN	3
2.2 Installing TF in a virtual environment	4
2.3 Setting up Pycharm	4
3. Installing the Movidius SDK	5
3.1 Installing OpenCV	7
4. Using The Movidius SDK	7
4.2 generating the inference-only graph	7
4.3 Using the inference-only graph	8
4.3.1 Code that uses the API without a webcam	10
4.3.2 Code that uses the API with a webcam	12
5. Setting up Raspberry Pi and using the NCS	14
5.1 Setting up the Pi	14
5.2 Setting up NCSDK on the Pi	15
...
This concludes the main tutorial, in the next part of the project, I’ll be showing you how to do real time face detection, following these same steps, but with a more advanced Neural Network
